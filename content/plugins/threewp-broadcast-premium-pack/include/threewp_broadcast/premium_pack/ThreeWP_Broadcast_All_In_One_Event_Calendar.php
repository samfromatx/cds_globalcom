...
/**
	@brief		Adds support for broadcasting All In One Calendar events.
	@since		2014-07-12 23:42:28
**/
class ThreeWP_Broadcast_All_In_One_Event_Calendar
	extends \threewp_broadcast\premium_pack\base
{
	...
	**/
	...
	/**
		@brief		Modify the meta box. Maybe.
		@since		2014-07-12 23:43:46
	**/
	public function threewp_broadcast_prepare_meta_box( $action )
	{
		$action->meta_box_data->html->put( 'broadcast_ai1c', $this->generate_meta_box_info() );
	}
	...
	**/
	...
	/**
		@brief		generate_meta_box_info
		@since		2014-07-12 23:48:24
	**/
	public function generate_meta_box_info()
	{
		if ( ! $this->has_ai1ec() )
			return;
		...
		return $this->p_( 'All In One Calendar v%s detected.', AI1EC_VERSION );
	}
	...
	**/
	...
	{
		return $this->get_ai1ec()->return_registry();
	}
...
$ThreeWP_Broadcast_All_In_One_Event_Calendar = new ThreeWP_Broadcast_All_In_One_Event_Calendar;
