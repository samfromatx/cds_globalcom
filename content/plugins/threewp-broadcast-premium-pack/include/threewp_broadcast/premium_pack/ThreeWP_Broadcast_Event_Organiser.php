...
**/
class ThreeWP_Broadcast_Event_Organiser
	extends \threewp_broadcast\premium_pack\base
{
	...
	{
		if ( $this->eo_installed() )
			$text = sprintf( 'Event Organiser %s detected.', EVENT_ORGANISER_VER );
		else
			$text = sprintf( 'Event Organiser was not detected.' );

		$action->meta_box_data->html->put( 'event_organiser', $text );
	}
	...
	{
		$action->text .= $this->p_( '%s: Venues can only be broadcasted, not updated.',
...
$ThreeWP_Broadcast_Event_Organiser = new ThreeWP_Broadcast_Event_Organiser();
