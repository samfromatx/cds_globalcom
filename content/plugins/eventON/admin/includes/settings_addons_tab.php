	...
	<div class='evo_addons_page addons'>
		...
		<?php // ADDONS 
			...
			global $wp_version; 
				...
				$eventon_addons_opt = serialize($eventon_addons_opt);
				$evo_licenses = serialize($evo_licenses);
			
			?>
				
				<div id='evo_addons_list' data-addons='<?php echo $eventon_addons_opt;?>' data-licenses='<?php $evo_licenses;?>' data-url='<?php echo AJDE_EVCAL_URL.'/admin/includes/addon_details.php';?>'>
