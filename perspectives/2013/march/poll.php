...
$options[1] = 'Provides accurate, up-to-date lists';
$options[2] = 'Offers insights into the makeup of your existing customer base';
$options[3] = 'Performs in-depth data analysis that allows you to target those prospects most likely to make a purchase';
